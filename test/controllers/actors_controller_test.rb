...
class ActorsControllerTest < ActionController::TestCase
  ...
  test "should create actor" do
    assert_difference('Actor.count') do
      post :create, actor: { biography: @actor.biography, email: @actor.email, facebook_profile: @actor.facebook_profile, gender: @actor.gender, identity: @actor.identity, name: @actor.name }
    end
  ...
  test "should update actor" do
    patch :update, id: @actor, actor: { biography: @actor.biography, email: @actor.email, facebook_profile: @actor.facebook_profile, gender: @actor.gender, identity: @actor.identity, name: @actor.name }
    assert_redirected_to actor_path(assigns(:actor))
  end
