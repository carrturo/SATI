...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    assert_difference('Play.count') do
      post :create, play: { duration: @play.duration, end_date: @play.end_date, promotional_video: @play.promotional_video, summary: @play.summary, title: @play.title }
    end
  ...
  test "should update play" do
    patch :update, id: @play, play: { duration: @play.duration, end_date: @play.end_date, promotional_video: @play.promotional_video, summary: @play.summary, title: @play.title }
    assert_redirected_to play_path(assigns(:play))
  end
